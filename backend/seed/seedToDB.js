import dns from "dns";
// Force reliable public DNS for Node.js SRV resolution on all networks
try {
...
async function seedDatabase() {
  console.log("🔌 Connecting to MongoDB Atlas with Google DNS...");
  try {
    ...
    // Seed 19 menu items
    console.log("🌱 Inserting 19 researched menu items into MongoDB...");
    let itemCount = 0;
    ...
    const beansInDB = await Bean.countDocuments();
    console.log(`🎉 SUCCESS! Stored ${totalInDB} menu items and ${beansInDB} bean blends in the MongoDB Atlas database!`);
